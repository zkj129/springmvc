...
public class Customer implements Serializable {
    ...
    public String getCustContury() {
        return custContury;
    }

    public void setCustContury(String custContury) {
        this.custContury = custContury;
    }
    ...
    public boolean equals(Object that) {
        ...
        return (this.getCustId() == null ? other.getCustId() == null : this.getCustId().equals(other.getCustId()))
            ...
            && (this.getCustContury() == null ? other.getCustContury() == null : this.getCustContury().equals(other.getCustContury()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCustContury() == null) ? 0 : getCustContury().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", custContury=").append(custContury);
